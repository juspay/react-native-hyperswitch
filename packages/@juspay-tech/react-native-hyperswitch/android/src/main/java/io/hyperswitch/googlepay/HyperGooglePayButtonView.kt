...
class HyperGooglePayButtonView(
  ...
  private fun configureGooglePayButton(): PayButton {
    ...
    googlePayButton.setOnClickListener { _ ->
      (this.parent as? View)?.performClick() ?: run {
        Log.e("Hyperswitch", "Unable to find parent of HyperGooglePayButtonView.")
      }
    }
  ...
  private fun buildButtonOptions(): ButtonOptions {
    val options = ButtonOptions
      .newBuilder()
      .setAllowedPaymentMethods(JSONArray().toString())
